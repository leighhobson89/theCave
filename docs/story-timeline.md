...
| 27 Jul 1901 (afternoon–evening) | Both boys enter the abandoned B Shaft. Andrew returns to Spencer Farm alone, severely injured (deep scratches, a long leg cut, left hand nearly severed), and collapses recounting the story before losing consciousness partway through and **dying at the farm that same evening**, in one continuous, unbroken scene in `story_en.md` (no day-break or "that night" skip — Diane is still at his side when he dies, before John, Simon and Tony have even made it back). No explanation is ever established for the exact circumstances of his injuries. Arnie is never found. | `story_en.md`; `reports_evidences_{en,de,es,fr,it}.json` (missingReport) |
| 28 Jul 1901 | **Not a second date of death** — the local Coroner formally confirms Andrew's cause of death (blood loss/shock) the day after, per the missing-person report's own wording ("confirmed by the local Coroner on 28 July"). This doc previously misread that clause as Andrew dying on the 28th; he died the evening before, per `story_en.md` above. | `reports_evidences_{en,de,es,fr,it}.json` (missingReport) |
...
- **Andrew John Spencer** (b. 12 Aug 1888 – d. 27 Jul 1901) — elder brother. Returns from the cave fatally injured and dies at the farm that same evening; his account of the second visit, cut short when he loses consciousness, is the only first-hand record of what happened. (The Coroner's formal cause-of-death confirmation is dated 28 Jul — see §1 — which is not the same thing as the date of death.)
