...
| `resume-after-refresh.spec.js` | Resume Game after a refresh versus returning to an in-memory game |
| `save-load-round-trip.spec.js` | Full LZString save payload round trip: evidence, notes, new-game defaults |
| `sticky-save.spec.js` | localStorage seed write, autosave timer, timer de-duplication, corrupt-save recovery, no collateral damage to other keys |
