...
`addAudioToEchotrail`'s real, in-fiction caller lives outside this folder: `facsimile-system/milestone-triggers.spec.js` covers a fax whose whole purpose is calling it — see that folder's README.
