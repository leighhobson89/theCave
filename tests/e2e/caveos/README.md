...
| `snake.spec.js` | Starting on Enter, moving on its own, a legal turn being taken and a reversal onto its own neck being refused, ending at a wall, restarting, the loop stopping when the window closes, and localization in all five languages |
